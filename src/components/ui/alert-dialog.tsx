  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ...
        className={cn(
          "bg-slate-950 border border-slate-800/70 shadow-xl shadow-blue-900/30",
          "rounded-2xl p-6 sm:max-w-lg w-full text-white",
          "data-[state=open]:animate-in data-[state=closed]:animate-out",
          "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
...
function AlertDialogTitle({
  ...
  return (
    <AlertDialogPrimitive.Title
      ...
      className={cn("text-xl font-bold text-blue-400", className)}
      {...props}
    />
  )
}
...
function AlertDialogAction({
  ...
  return (
    <AlertDialogPrimitive.Action
      className={cn(
        buttonVariants(),
        "bg-blue-700 hover:bg-blue-600 text-white shadow-md shadow-blue-900/40",
        className
      )}
      {...props}
    />
